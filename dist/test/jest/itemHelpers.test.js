...
import fetchFromUniversalis, { mockReturnValue, mockReturnValueOnce, mockImplementation, mockResolvedValue } from "../../src/fetchFromUniversalis";

import { phantasmagoria as PhantasmagoriaHelpers, gatherable as GatherableHelpers } from "../../src/itemHelpers";
import { PhantaItem, GatherableItem } from "../../models/Item.model";
...
describe("itemHelpersTest", () => {
  ...
  describe("getItems", () => {
    ...
    beforeEach(async () => {
      mockResolvedValue(universalisReturnValueFive);
      await PhantaItem.deleteMany();
      length = (
